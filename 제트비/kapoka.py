...
def crawl_category(url):
    ...
    for page in range(max_page):
        ...
        cate_link = []
        # 상품 목록 가져오기
        product_elements = driver.find_elements(By.XPATH, '/html/body/div[2]/div/div[1]/div[2]/div[2]/ul/li')
        time.sleep(0.25)
...
def main():
    ...
    category_url = "https://www.zbcrew.com/product/list.html?cate_no=119"
    cate_list = ['033021']
    cate_name = ['펠트가드']
    mall='제트비'
